...
const API_KEY = "6daed23035c8412090df0e53a47faecb";
        ...
        const checkCompletion = setInterval(async ()=>{
            ...
            switch(response.data.status){
                ...
                case "completed":
                    ...
                    if (response.data.text != null) clearInterval(checkCompletion);
                    break;
                case "error":
                    console.log("Error");
                    loading.textContent = "There has been an error, please try again";
                    loader.style.display = "none";
...
},{}]},["7Aums","bNKaB"], "bNKaB", "parcelRequire4a12")
